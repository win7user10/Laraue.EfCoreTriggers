...
namespace Laraue.EfCoreTriggers.SqlLiteTests.Unit
{
    ...
    public class SqlLiteUnitMemberAssignmentTests : BaseMemberAssignmentUnitTests
    {
        ...
        public override string ExceptedDateTimeOffsetNowSql => "INSERT INTO \"destination_entities\" (\"date_time_offset_value\") SELECT DATETIME('now', 'localtime');";
        public override string ExceptedDateTimeOffsetUtcNowSql => "INSERT INTO \"destination_entities\" (\"date_time_offset_value\") SELECT DATETIME('now');";

        public override string ExceptedNewDateTimeOffsetSql => "INSERT INTO \"destination_entities\" (\"date_time_offset_value\") SELECT '0001-01-01T00:00:00+00:00';";
