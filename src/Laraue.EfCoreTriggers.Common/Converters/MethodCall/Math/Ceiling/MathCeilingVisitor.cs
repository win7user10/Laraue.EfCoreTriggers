...
{
    public class MathCeilingVisitor : BaseMathVisitor
    {
        protected override string MethodName => nameof(System.Math.Ceiling);

        public MathCeilingVisitor(IExpressionVisitorFactory visitorFactory) 
            : base(visitorFactory)
        {
        }
            ...
            VisitedMembers visitedMembers)
        {
            ...
            return SqlBuilder.FromString($"CEILING({sqlBuilder})");
        }
    }
}
