...
public class UnaryExpressionVisitor : BaseExpressionVisitor<UnaryExpression>
{
    ...
    public UnaryExpressionVisitor(IExpressionTreeVisitorFactory factory, ISqlGenerator generator) 
        : base(factory)
    {
    ...
    {
        var internalExpressionSql = Visit(expression.Operand, argumentTypes, visitedMembers);
